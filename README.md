...
- **A股 AI/半导体 投研报告系列**（7/10–7/28 持续更新，已 10 篇）— 每日基于 Tushare 量价/财报金标准 × 6 簇并行 Web 核查 Workflow × 桌面卖方研报交叉验证的 A 股 AI 产业链投研报告；核心方法论：用区间视角（自前期高点回撤）判低估 vs 泡沫，产业链利好 ≠ 选股时点 ≠ 拥挤度 ≠ 流动性虹吸；暴跌先辨「杀估值不杀业绩」（PE 压缩 vs 业绩崩塌，前者给低 PEG 标的送买点），去伪存真四色分化（研究支持用途，不构成买卖指令）
