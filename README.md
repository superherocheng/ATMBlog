...
- **A股 AI/半导体 投研报告系列**（7/10–7/31 持续更新，已 12 篇；另配套《全球宏观 × A股交叉验证》简报）— 每日基于 Tushare 量价/财报金标准 × 5 簇并行 Web 核查 Workflow × 桌面卖方研报交叉验证的 A 股 AI 产业链投研报告；核心方法论：用区间视角（自前期高点回撤）判低估 vs 泡沫，产业链利好 ≠ 选股时点 ≠ 拥挤度 ≠ 流动性分流；暴跌先辨「杀估值不杀业绩」（PE 压缩 vs 业绩崩塌，前者给低 PEG 标的送买点）；管理层回购/增持 > 卖方纸面目标价（现价跌破分析师共识最低 = 极强低估锚）；反弹看分化（宽基涨 vs 科创50 逆势创新低 = 去杠杆未竟、反弹非反转），V 型技术反弹判「V 反非反转」（须放量收复 MA20 方可谈反转）；宏观面（FOMC/PCE/海外 capex/政策底）与聚焦标的速评双向交叉验证，去伪存真四色分化（研究支持用途，不构成买卖指令）
