...
- **A股 AI/半导体 投研报告系列**（7/10–7/27 持续更新，已 9 篇）— 每日基于 Tushare 量价/财报金标准 × 6 簇并行 Web 核查 Workflow × 桌面卖方研报交叉验证的 A 股 AI 产业链投研报告；核心方法论：用区间视角（自前期高点回撤）判低估 vs 泡沫，产业链利好 ≠ 选股时点 ≠ 拥挤度 ≠ 流动性虹吸（研究支持用途，不构成买卖指令）
