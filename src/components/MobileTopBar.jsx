...
export default function MobileTopBar({ onMenuToggle }) {
  ...
  return (
    <div className="md:hidden flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-4 py-3 fixed top-0 left-0 right-0 z-40 bg-white dark:bg-[#121212]">
