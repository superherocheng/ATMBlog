...
const allArticles = [
  ...
  },
  {
    ...
    title: 'A股 AI/半导体 · 7/27 补班交易日技术性反弹 + 长鑫上市虹吸重塑风格（2026-07-27）',
    excerpt: '7/27 补班交易日技术性反弹（创业板 +3.16%/中证1000 +3.33% 跌多反弹多）但仍破 MA20（反弹非反转）。本期最大修正：0724"长鑫上市催化设备簇 V 反"被证伪——长鑫首日 +465%/市值 3.28 万亿超工行/单日成交 901 亿虹吸半导体大票流动性，设备簇+算力簇全面滞涨，PCB/光模块领涨（谷歌上调 capex 至 2050 亿+高端 PCB 涨价 300% 反向证伪"海外 capex 见顶担忧"）。首选工富（7/28 回购价上限 103 元 +67% 全池最强信号）/沪电/新易盛（升级光模块首选）/澜起（升级买入）/华工（董事长增持）；避雷天孚/光迅（股价反创新高未反映下调）/拓荆（倒挂 −32% 泡沫）/至纯（续亏+治理+公司自警）/寒武纪（PE287+美制裁）。下调：生益（买入→持有，PE 簇内最高+国内目标倒挂）、芯原（hedge 首选→观望）。',
    date: '2026-07-27',
    readTime: '22 min read',
    tag: 'A STOCK',
  },
