...
const allArticles = [
  ...
  },
  {
    ...
    title: '洛阳钼业 vs 紫金矿业 · 三大曲线 · 量价基本面 · 短中长期空间测算（2026-08-05）',
    excerpt: '2026-08-05 洛钼、紫金同步放量大涨 6%+ 站上全部均线——1 月高点以来 -21~24% 的回调是「杀估值不杀业绩」（PE 从 26x 砍到 10-15x、净利却翻倍）。三大曲线（股价/量能/估值）+ 量价基本面 + 商品驱动全拆解：紫金 forward PE 10.8x/ROE 33% 更稳（金铜锂三轮、机构目标 39-56 元），洛钼 forward PE 12.8x 是更纯的铜弹性（铜毛利占六成、铜价每涨 5000 元归母 +12 亿）。当前价≈中性情景，中性看两票都有 ~25% 空间到一致目标价，乐观看紫金 40-60%/洛钼 30%；前提是铜金维持高位 + 加息预期别复活。',
    date: '2026-08-05',
    readTime: '15 min read',
    tag: '有色金属',
  },
