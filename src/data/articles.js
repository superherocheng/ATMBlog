...
const allArticles = [
  ...
  },
  {
    ...
    excerpt: '7/27 补班交易日技术性反弹（创业板 +3.16%/中证1000 +3.33%，跌多反弹多）但仍破 MA20，反弹非反转。本期最大修正：长鑫上市首日 +465%/成交 901 亿虹吸半导体大票，设备/算力簇滞涨（证伪上期"催化设备 V 反"）；谷歌上调 capex + PCB 涨价反向证伪"海外 capex 见顶"，PCB/光模块领涨。首选工业富联（回购价上限 103 元 +67% 全池最强信号）、沪电、新易盛（升级光模块首选）、澜起（升级买入）、华工；下调生益（PE 簇内最高+国内目标倒挂）；避雷天孚/光迅/拓荆/至纯/寒武纪。',
    date: '2026-07-27',
    readTime: '22 min read',
    tag: 'A STOCK',
  },
