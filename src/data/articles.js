...
const allArticles = [
  ...
  },
  {
    ...
    title: 'A股 AI/半导体速评 · 2026-08-18 上证一个半月来首收MA60：隔夜SOX+1.6%而光模块主力出逃23亿——"海外利好、A股兑现"，高低切换入验真周（天孚/兆易明晚开考）',
    excerpt: '8/18 沪强深弱高低切：上证 3990 首收 MA60（6 月末以来首次、7 大指数唯一），但隔夜 SOX +1.64%/闪迪 +8.9%/Coherent +7.7% 而 A股光模块反跌——主力从 AI 硬件全链撤出（旭创 −23 亿全市场第一）切设备/农业（美伊谈崩+30Y 美债 5.29% 点燃"通胀交易"，种植业 +9.5% 全场第一）；8/17"透支组领涨"单日即逝，光库正文符合预告次日即跌=光模块"符合即兑现"模板。首选沪电（+53%）/工富（PE 28 最低）/光模块双雄（8/24-25 正文前不满仓）/中芯（里昂 A 股新锚 180.2）；避雷中石科技（三连板超旭创受让锚 74%+晚公告"验证期"）、天孚（明晚正文、预告中值低于一致预期）、寒武纪。',
    date: '2026-08-18',
    readTime: '22 min read',
    tag: 'A STOCK',
  },
